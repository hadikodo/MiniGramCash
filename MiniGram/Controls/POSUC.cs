...
namespace MiniGram.Controls
{
    public partial class POSUC : UserControl
    {
        ...
        private void InitComboDiscount()
        {
            ...
            DictionaryDiscount.Add(1, "Employee Discount");
        ...
        private void getExistingReceipt()
        {
            ...
            cboxDiscount.SelectedValue = !String.IsNullOrEmpty(cardNumber) ? 1 : 0;
            foreach (TBLPRODUCT product in productList)
            {
                try
                {
                    ...
                    if (cboxDiscount.SelectedValue.ToString() == "0")
                        discount = 0;
                    else if (cboxDiscount.SelectedValue.ToString() == "1")
                        discount = data.sp_getProductByName(pname).ToList()[0].InitPrice == 0 ? 0 : dollar - secondaryPrice;
                    else if (cboxDiscount.SelectedValue.ToString() == "2")
                    ...
                    for (int i = 0; i < holdItem.QTE; i++)
                    {
                        ...
                        if (!exist)
                        {
                            receipt_details.Rows.Add(barcode, pname, supplier, 1, dollar, lbp, lbp, dollar, tva, discount, secondaryPrice);
                            tot_quantity.Text = getTotalQTE();
                            tot_net_dollar.Text = getTotalDollar() + " $";
                            tot_tva.Text = (Double.Parse(getTotalTVA())).ToString() + " $";
                            double TotalDiscount = Double.Parse(getTotalDiscount());
        ...
        private void add_btn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cboxDiscount.SelectedValue.ToString() == "0")
                    ...
                    discount = data.sp_getProductByName(pname).ToList()[0].InitPrice == 0 ? 0 : inputQte * ( dollar - secondaryPrice);
                else if (cboxDiscount.SelectedValue.ToString() == "2")
                ...
                foreach (DataGridViewRow row in receipt_details.Rows)
                {
                    if (row.Cells[1].Value.Equals(pname))
                    {
                        ...
                        row.Cells[4].Value = cboxDiscount.SelectedValue.ToString() == "1" ? secondaryPrice : dollar;
                        row.Cells[5].Value = cboxDiscount.SelectedValue.ToString() == "1" ? Int32.Parse((secondaryPrice * Double.Parse(Properties.Settings.Default.dollarLBPPrice.ToString())).ToString()) : lbp;
                        row.Cells[6].Value = Int32.Parse((double.Parse(row.Cells[3].Value.ToString()) * double.Parse(lbp.ToString())).ToString());
                        row.Cells[7].Value = double.Parse(row.Cells[3].Value.ToString()) * dollar;
                ...
                if (!exist)
                {
                    receipt_details.Rows.Add(barcode, pname, supplier, inputQte, cboxDiscount.SelectedValue.ToString() == "1" ? secondaryPrice : dollar, cboxDiscount.SelectedValue.ToString() == "1" ? Int32.Parse((secondaryPrice * Double.Parse(Properties.Settings.Default.dollarLBPPrice.ToString())).ToString()) : lbp, lbp, dollar, tva, discount, secondaryPrice);
                    tot_quantity.Text = getTotalQTE();
                    tot_net_dollar.Text = getTotalDollar() + " $";
                    tot_discount.Text = getTotalLBP() + " LBP";
                    tot_tva.Text = (Double.Parse(getTotalTVA())).ToString() + " $";
        ...
        private void change_quantity_btn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Globals.deleteNB > 0)
                {
                    ...
                    receipt_details.SelectedRows[0].Cells[4].Value = cboxDiscount.SelectedValue.ToString() == "1" ? secondaryPrice : dollar;
                    receipt_details.SelectedRows[0].Cells[5].Value = cboxDiscount.SelectedValue.ToString() == "1" ? Int32.Parse((secondaryPrice * Double.Parse(Properties.Settings.Default.dollarLBPPrice.ToString())).ToString()) : Int32.Parse((dollar * Double.Parse(Properties.Settings.Default.dollarLBPPrice.ToString())).ToString());
        ...
        private void updateDiscountPrices(int discountSelection)
        {
            if (receipt_details.Rows.Count != 0)
            {
                foreach (DataGridViewRow row in receipt_details.Rows)
                ...
                if (Globals.deleteNB != 0)
                {
                    ...
                    else
                    {
                        ...
                        if (cboxDiscount.SelectedValue.ToString() == "0")
                            ...
                            discount = data.sp_getProductByName(pname).ToList()[0].InitPrice == 0 ? 0 : Double.Parse(receipt_details.SelectedRows[0].Cells[4].Value.ToString()) - secondaryPrice;
                        else if (cboxDiscount.SelectedValue.ToString() == "2")
                        ...
                        receipt_details.SelectedRows[0].Cells[10].Value = secondaryPrice;
                        if (Double.Parse(receipt_details.SelectedRows[0].Cells[8].Value.ToString()) != 0)
                            receipt_details.SelectedRows[0].Cells[8].Value = (Double.Parse((Double.Parse(receipt_details.SelectedRows[0].Cells[3].Value.ToString()) * Double.Parse(receipt_details.SelectedRows[0].Cells[10].Value.ToString()) * Double.Parse(Properties.Settings.Default.TVAPercentage.ToString())).ToString()) / 100).ToString();
                    }
                    tot_quantity.Text = getTotalQTE();
                    tot_net_dollar.Text = getTotalDollar() + " $";
                    tot_discount.Text = getTotalLBP() + " LBP";
                    ...
                    using (var ax = new MiniGramDBDataContext(Properties.Settings.Default.ConnectionString))
                    {
                        try
                        {
                            ...
                            if (!exist)
                            {
                                ...
                                tot_net_dollar.Text = getTotalDollar() + " $";
                                tot_discount.Text = getTotalLBP() + " LBP";
                                tot_tva.Text = (Double.Parse(getTotalTVA())).ToString() + " u$";
                                double TotalDiscount = Double.Parse(getTotalDiscount());
                                tot_discount.Text = TotalDiscount.ToString() + " $";
                                tot_final_price_dolar.Text = getFinalPriceDollar(TotalDiscount).ToString() + " $";
                                tot_final_price_lbp.Text = getFinalPriceLBP(TotalDiscount).ToString("#,0;-#,0") + " LBP";// + " LBP";
