...
namespace MiniGram.Forms
{
    ...
    {
        public double totalDollar, totalLBP, restDollar = 0, restLBP = 0, customerDollar = 0, customerLBP = 0, rate = Double.Parse(Properties.Settings.Default.BuyDollarLBPPrice.ToString());
        ...
        private void ExtendedCheckoutForm_Load(object sender, EventArgs e)
        {
            ...
            this.ActiveControl = txtCustomerDollar;           
            refreshTxtBoxes();
        }
